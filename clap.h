...
// switches on the command line (see main.c and sim_xplor.c for
// example usage).
//
...
// Invocation:
//
// progname -argname1 argval1 -argname2 argval2 ...
...
else if (strncmp(#argtype,"bool",    CLAP_ARGTYPE_MAX) == 0) printf("%-12s %-24s %s\n",  #argname, *(int*)     clap_v##argname ? "true" : "false", argdesc); \
